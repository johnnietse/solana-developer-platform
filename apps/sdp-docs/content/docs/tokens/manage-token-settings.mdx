...
- [Freeze and Compliance](/docs/tokens/freeze-and-compliance) — freeze accounts, pause transfers, seize tokens
- [Prepare vs Execute](/docs/tokens/prepare-vs-execute) — when to use each signing mode
- [Allowlists](/docs/tokens/allowlists) — manage approved token holders
